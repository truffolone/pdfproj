 ...
 */
class Version20180326142757 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE text_pages CHANGE title title VARCHAR(255) DEFAULT NULL, CHANGE text text LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE text_pages CHANGE title title VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, CHANGE text text LONGTEXT DEFAULT NULL COLLATE utf8_unicode_ci');
    }
}
