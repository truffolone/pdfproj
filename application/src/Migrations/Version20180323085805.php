 ...
 */
class Version20180323085805 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE products CHANGE active active TINYINT(1) DEFAULT \'1\'');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE products CHANGE active active TINYINT(1) DEFAULT \'1\' NOT NULL');
