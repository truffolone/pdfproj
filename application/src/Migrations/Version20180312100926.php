 ...
 */
class Version20180312100926 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE document CHANGE ordine ordine SMALLINT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE document CHANGE ordine ordine SMALLINT NOT NULL');
