 ...
 */
class Version20180412135246 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE products ADD publicRevision INT DEFAULT 1 NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE products DROP publicRevision');
