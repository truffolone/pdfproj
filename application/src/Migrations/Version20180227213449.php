 ...
 */
class Version20180227213449 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE attribute_name_value ADD CONSTRAINT FK_D7370D14FA8BC512 FOREIGN KEY (attribute_name_id) REFERENCES attribute_names (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE attribute_name_value ADD CONSTRAINT FK_D7370D1465A22152 FOREIGN KEY (attribute_value_id) REFERENCES attribute_values (id) ON DELETE CASCADE');
