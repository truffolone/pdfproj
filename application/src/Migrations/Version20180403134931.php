 ...
 */
class Version20180403134931 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE categories ADD ordine SMALLINT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE categories DROP ordine');
